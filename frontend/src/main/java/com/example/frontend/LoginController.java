                ...
                if (response.statusCode() == 200) {
                    ...
                    if (responseJson.has("data")) {
                        ...
                        if (data.has("accessToken")) {
                            ...
                            System.out.println("Access Token là: " + accessToken);
                            LoginController.userToken = accessToken;
                        } else {
                            System.out.println("Không có accessToken trong data");
                        }
                    } else {
                        System.out.println("Phản hồi không chứa data");
                    }
                } else {
                    System.out.println("Đăng nhập thất bại. Status: " + response.statusCode());
                }
